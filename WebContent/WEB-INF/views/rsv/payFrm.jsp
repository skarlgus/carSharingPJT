	...
	<div class="bg-light" style="height: 100%; width: 100%;">
		<div class="container">
			...
			<h1 class="display-4" style="padding-top: 30px;">
				<img src="/img/sohyeon/pay.png" height=64px> 결제
			</h1>
			<br>
			<p>
				<span class="bold">예약 정보</span>와 <span class="bold">결제 정보</span>를
				정확히 확인한 후에 진행해주세요.<br> 셀카 서비스를 이용해주셔서 감사합니다.
	...
	<div class="container" style="padding-bottom: 5%;">
		...
		<div class="row">
			<div class="col-md-4 order-md-2 mb-4">
				...
				<a href="/myRsvList?userId=<%=user.getUserId()%>&reqPage=1">내 예약
					리스트로 가기</a>
			</div>
			<div class="col-md-8 order-md-1" style="padding-top: 5%;">
				...
				<div class="custom-control custom-checkbox">
					<input type="checkbox" class="custom-control-input"
						id="check-rsvpay" name="check-rsvpay"> <label
						class="custom-control-label" for="check-rsvpay">예약, 결제정보를
						모두 확인했습니다</label> <br>
					<p id="paymentResult"></p>
				</div>
				<hr class="mb-4">
				<div id="pay1">
					<button class="btn btn-lg btn-block yellowBtn">결제하기</button>
				</div>
...
<script>
		$(function() {
			...
			$("#pay1 button").click(function(){
				console.log("1");
				if($("input:checkbox[name=check-rsvpay]").is(":checked")){
					
						var p1 = "<%=rsv.getRsvPrice()%>";
						var price = Number(p1.replaceAll(",",""));
