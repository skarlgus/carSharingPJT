	...
	<div class="bg-light" style="height: 100%; width: 100%;">
		<div class="container">
			...
			<h1 class="display-4" style="padding-top: 30px;">
				<img src="/img/sohyeon/siren.png" height=64px> 회원 신고 <img
					src="/img/sohyeon/siren.png" height=64px>
			</h1>
			<br>
			<p>
				이용에 불편을 드려서 죄송합니다!<br> <br> 신고하려는 회원의 <span class="bold">아이디</span>와
				<span class="bold">예약 정보</span>를 다시 한번 확인해주시고, 정확하고 타당한 이유를 작성해주세요!<br>
				신고내용은 관리자에게 전달되어 검토 후 신고된 회원의 <span class="bold">회원 등급 조정 /
					유지</span>가 결정됩니다.<br> 저희 <span class="bold">셀카</span>는 회원님들에게 항상
				안전하고, 편안한 렌트 서비스를 제공하기위해 더욱 더 노력하겠습니다! 감사합니다. <br> <br>
				사지말고 셀카하자! <span class="bold">selcar</span>
		...
		<div class="table-responsive"
			...
			<form action="/insertReport" method="post">
				<table class="table table-sm">
					...
					<tr>
						<input type="hidden" name="whom" value="user">
					...
					<tr>
						<th>내 차량</th>
						<td colspan="3" style="text-align: left;"><%=car.getCarNopan()%></td>
					</tr>

					<tr>
						<th>신고할 회원</th>
						<td colspan="3" style="text-align: left;"><%=rsv.getUserId()%></td>
					</tr>


					<tr>
						<th style="line-height: 150px;">신고 이유</th>
						<td colspan="3"><textarea name="reportContent"
								class="form-control" rows="7" cols="40" style="resize: none;"
