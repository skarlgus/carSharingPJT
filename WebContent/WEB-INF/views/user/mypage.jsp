...
<body>
  ...
  <script src="https://t1.daumcdn.net/mapjsapi/bundle/postcode/prod/postcode.v2.js"></script>
   ...
   <%@ include file="/WEB-INF/views/common/header.jsp" %>
      <form action="/updateMember" method="post" style="width : 800px; margin:0 auto; margin-top :180px; color:black; z-index:3000">
         ...
         <table class="table">
            ...
            <button class="btn btn_info btn-lg" type="submit">수정하기</button>
      
                     <button class="btn btn_info btn-lg" type="button" onclick="location.href='/adminPage?reqPage=1'">회원관리</button>
            <button class="btn btn_info btn-lg" type="button" onclick="location.href='/reportUser?reqPage=1'">신고관리</button>
               </th>
            </tr>
         </table>
      </form>
