...
<body>
<div class="wrapper">
   <div class="logo"><img src="/img/main3.png" onclick="location.href='/'" style="cursor: pointer; width : 300px; height : 150px;"></div>
   <form action="/login" method="post" id="login-box">
      ...
      <button type="submit" style="cursor: pointer;">로그인</button><br><br>
      <div class="list">
      <ul class="menu">
...
<script>
   $("input[name=userId]"),$("input[name=userPw]").keyup(function(){
      ...
      button.css('background-color','#FAC60E');
   });
</script>
</body>
</html>