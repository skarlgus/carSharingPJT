...
public class RsvDao {
	...
	public int updateReport(Connection conn, String reportee) {
		PreparedStatement pstmt = null;
		int result = 0;
		User user = new UserService().selectOneMember(reportee);
	...
	public ArrayList<Report> selectAllMember(Connection conn) {
		...
		String query = "select * from report order by REPORT_NO desc";
	...
	public int reportAllDecision(Connection conn, int reportNo, String userId) {
		PreparedStatement pstmt = null;
		int result = 0;
	...
	public ArrayList<Report> searchReportTo(Connection conn, String keyword) {
		PreparedStatement pstmt = null;
		ResultSet rset = null;
		String query = "select *from report where REPORT_ER like (?)";
		ArrayList<Report> list = new ArrayList<Report>();
		try {
			pstmt = conn.prepareStatement(query);
	...
	public ArrayList<Report> searchReportFrom(Connection conn, String keyword) {
		PreparedStatement pstmt = null;
		ResultSet rset = null;
		String query = "select *from report where REPORT_EE like (?)";
		ArrayList<Report> list = new ArrayList<Report>();
		try {
			pstmt = conn.prepareStatement(query);
			pstmt.setString(1, '%' + keyword + '%');
