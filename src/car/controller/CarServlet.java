...
public class CarServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		// 3.비지니스로직
		int delete = new CarService().deleteCar(userId);
		int result = new CarService().insertCar(car);
		/*
		 * Car result2 = new CarService().selectCarDetailView(userId);
		 * System.out.println("==============");
		 * System.out.println(result2.getCarName()); if(result2 != null) {
		 * request.setAttribute("carInfo", result2); }
		 */
