...
//
	...
	public int insertCar(Connection conn, Car car) {
		PreparedStatement pstmt = null;
		int result = 0;
		String query ="insert into car values(car_seq.nextval,?,?,?,?,?,?,?,?,?,?,0,?,?,?)";
		try {
			pstmt = conn.prepareStatement(query);
			...
			pstmt.setString(6, car.getCarLocation());
			pstmt.setString(7, car.getCarPrice());
			pstmt.setString(8, car.getCarSdate());
			pstmt.setString(9, car.getCarEdate());
			pstmt.setString(10, car.getCarNopan());
			pstmt.setString(11, car.getCarImage2());
			pstmt.setString(12, car.getCarImage3());
			pstmt.setString(13, car.getCarImage4());
	...
	public ArrayList<Car> searchKeyword(Connection conn, String location, String carType, 
	 ...
	 public int deleteCar(Connection conn, String userId) {
	      PreparedStatement pstmt = null;
	      int result = 0;
	      String query = "delete from car where user_id=?";
	      try {
	         pstmt=conn.prepareStatement(query);
	         pstmt.setString(1, userId);
	         result=pstmt.executeUpdate();
